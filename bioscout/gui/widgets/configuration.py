...
class ConfigurationTab(ctk.CTkFrame):
    ...
    def _create_widgets(self) -> None:
        ...
        self._create_section(container, "Analysis Pipeline", self._create_analysis_section)

        # Section: CEINMS Parameters
        self._create_section(container, "CEINMS Parameters", self._create_ceinms_section)

        # Section: Processing
        self._create_section(container, "Processing Options", self._create_processing_section)

        # Section: GUI Settings
        self._create_section(container, "GUI Settings", self._create_gui_section)

        # Section: Recording Settings
        self._create_section(container, "Recording Settings", self._create_recording_section)
    ...
    def _create_paths_section(self, parent) -> None:
        ...
        self._add_path_entry(parent, "Simulations Directory", "project.simulations_dir", "simulations")
        self._add_path_entry(parent, "Models Directory", "project.models_dir", "models")
        self._add_path_entry(parent, "Results Directory", "project.results_dir", "results")
